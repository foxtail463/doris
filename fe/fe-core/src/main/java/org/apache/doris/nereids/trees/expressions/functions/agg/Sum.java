...
public class Sum extends NullableAggregateFunction
        // 实现 ComputePrecisionForSum：在签名确定后，对 DecimalV3 的返回精度/scale 做专门推导
    ...
    // 该列表定义了 sum 在不同入参类型下对应的“类型签名”（参数类型 -> 返回类型）
    // 后续会先从这里选择一个“粗签名”，再通过 computeSignature/computePrecision 进行精度补全
    ...
    public FunctionSignature searchSignature(List<FunctionSignature> signatures) {
        // 特殊分支：NULL/DecimalV2 提前定向到相应签名；其他情况走通用多轮匹配（Identical/Implicit/Explicit）
